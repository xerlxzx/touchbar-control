...
When updating, quit the old copy before replacing it and launch the new copy from Applications. Keeping the older process running does not apply a downloaded or locally built fix. Check **About Touch Bar Control** for version 1.3.3.
